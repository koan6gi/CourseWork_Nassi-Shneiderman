...
function GetNodeInfo(const ID: Integer): TData; forward;
function GetNodeParent(const ID: Integer): PAdrOfNode; forward;
procedure InsertCycleBlockHeadInTree(var Branch: PAdrOfNode); forward;
procedure InsertIfBlockHeadsInTree(var Branch: PAdrOfNode); forward;
procedure MakeArr(Tree: PAdrOfNode; var Arr: TArrOfInd;
  var I: Integer); forward;
